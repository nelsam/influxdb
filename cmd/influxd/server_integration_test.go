...
func runTestsData(t *testing.T, testName string, nodes Cluster, database, retention string, replicationFactor int) {
	...
	tests := []struct {
		...
		{"name": "disk", "tags": {"host": "server03", "region": "caeast"},"time": "2009-11-10T23:00:00Z","fields": {"value": 100}}
		]}`,
			query:    "SHOW SERIES",
			queryDb:  "%DB%",
		...
		{"name": "gpu", "tags": {"host": "server02", "region": "useast"},"time": "2009-11-10T23:00:00Z","fields": {"value": 100}},
		{"name": "gpu", "tags": {"host": "server03", "region": "caeast"},"time": "2009-11-10T23:00:00Z","fields": {"value": 100}},
		{"name": "disk", "tags": {"host": "server04", "region": "caeast"},"time": "2009-11-10T23:00:00Z","fields": {"value": 100}}
		]}`,
		...
		{"name": "disk", "tags": {"host": "server03", "region": "caeast"},"time": "2009-11-10T23:00:00Z","fields": {"field8": 200, "field9": 300}}
		]}`,
