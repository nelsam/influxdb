...
import (
	...
	"gopkg.in/nelsam/influxdb.v0/admin"
	"gopkg.in/nelsam/influxdb.v0/api/collectd"
	"gopkg.in/nelsam/influxdb.v0/api/graphite"
	"gopkg.in/nelsam/influxdb.v0/api/http"
	"gopkg.in/nelsam/influxdb.v0/api/udp"
	...
	"gopkg.in/nelsam/influxdb.v0/wal"
)
